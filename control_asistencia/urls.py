...
urlpatterns = [
    ...
    path("estudiante/materias/<str:id>", estudiante_views.asistencias_de_materia, name="estudiante.asistencias_de_materia"),
    ...
    path("docente/materias/<int:id>", docente_views.seleccionar_materia_fecha, name="docente.seleccionar_materia_fecha"),
    path("docente/materias/<int:id>/qr_asistencia", docente_views.qr_asistencia, name="docente.qr_asistencia"),
    path("docente/materias/<int:id>/<str:fecha>", docente_views.asistencias_materia, name="docente.asistencias_materia"),
